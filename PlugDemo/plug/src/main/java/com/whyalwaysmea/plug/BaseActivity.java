...
/**
 * Created by HanLong on 2017/7/25.
 */
public class BaseActivity extends Activity {
    ...
    public static final String PROXY_VIEW_ACTION = "com.whyalwaysmea.plugin.proxy";
    public static final String DEX_PATH = "/mnt/sdcard/whyalwaysmea/plugin.apk";
