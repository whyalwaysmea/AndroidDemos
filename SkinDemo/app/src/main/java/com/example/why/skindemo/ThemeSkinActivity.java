...
import com.example.why.skindemo.adapter.DayNightAdapter;
import com.example.why.skindemo.utils.DayNightUtils;
 ...
 */
public class ThemeSkinActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    private DayNightUtils mDayNightUtils;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData();
        // 需要在setContentView之前，因为当 View 创建成功后 ，再去 setTheme 是无法对 View 的 UI 效果产生影响的
        initTheme();
    ...
    private void initData() {
        mDayNightUtils = new DayNightUtils(this);
    }

    private void initTheme() {
        if (mDayNightUtils.isDay()) {
    ...
    private void initView() {
        ...
        mRecyclerView.setAdapter(new DayNightAdapter());
    ...
    private void toggleThemeSetting() {
        if (mDayNightUtils.isDay()) {
            mDayNightUtils.setMode(DayNight.NIGHT);
            setTheme(R.style.NightTheme);
        } else {
            mDayNightUtils.setMode(DayNight.DAY);
            setTheme(R.style.DayTheme);
        }
    }
    ...
    private void refreshUI() {
        ...
        Resources.Theme theme = getTheme();         //获取主题
        // 检索主题中属性的值
